...
@section('title', 'گروه ها | GreenWork')
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">افزودن گروه جدید</h3>
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="form-group">
                        <label>داشبورد</label> 
                        <select name="home" class="form-control select2" >
                            <?php
//                            var_dump($user['load']);
                            foreach ($group['load']['home'] as $item) {
...
//                }
    ...
    <?php if ($group['info']->render() != ''): ?>
        <div class="box-footer clearfix">
            <?php echo $group['info']->appends(['search' => $params['search']])->render(); ?>
        </div>
    <?php endif; ?>
</div>
<!-- /.box -->
